        ...
        <div className="container">
          <div className="footer-content">
            ...
            <div className="footer-links">
              <div className="footer-col"><h3>המוצר</h3><ul><li><Link href="/#solution">תכונות</Link></li><li><Link href="/#pricing">מחירים</Link></li><li><Link href="/features">מה חדש</Link></li></ul></div>
              <div className="footer-col"><h3>החברה</h3><ul><li><Link href="/about">אודות</Link></li><li><a href="https://wa.me/972524824210" target="_blank" rel="noreferrer">צור קשר</a></li><li><a href="tel:+972524824210">052-4824210</a></li></ul></div>
              <div className="footer-col"><h3>משפטי</h3><ul><li><Link href="/privacy">מדיניות פרטיות</Link></li><li><Link href="/security">אבטחת מידע</Link></li><li><Link href="/terms">תנאי שימוש</Link></li><li><Link href="/regulations">תקנון</Link></li><li><button onClick={() => window.dispatchEvent(new CustomEvent('oria:open-cookie-consent'))} style={{background:'none',border:'none',padding:0,color:'inherit',font:'inherit',cursor:'pointer',textAlign:'right'}}>ניהול עוגיות</button></li></ul></div>
            </div>
          </div>
