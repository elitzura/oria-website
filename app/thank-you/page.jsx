        ...
        <div className="container">
          <div className="footer-content">
            ...
            <div className="footer-links">
              <div className="footer-col"><h4>המוצר</h4><ul><li><Link href="/features">מה חדש</Link></li><li><Link href="/pricing">מחירים</Link></li><li><Link href="/security">אבטחת מידע</Link></li></ul></div>
              ...
              <div className="footer-col"><h4>משפטי</h4><ul><li><Link href="/privacy">מדיניות פרטיות</Link></li><li><Link href="/terms">תקנון ותנאי שימוש</Link></li><li><button onClick={() => window.dispatchEvent(new CustomEvent('oria:open-cookie-consent'))} style={{background:'none',border:'none',padding:0,color:'inherit',font:'inherit',cursor:'pointer',textAlign:'right'}}>ניהול עוגיות</button></li></ul></div>
            </div>
          </div>
