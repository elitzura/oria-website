      ...
      <FeaturePageLayout>
        ...
        <div className="feature-body">
          ...
          <div className="how-steps">
            <div className="how-step">
              ...
              <div className="how-step-body">
                ...
                <a href="https://app.oriamind.ai/register" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '.35rem', marginTop: '.6rem', fontSize: '.85rem', fontWeight: 700, color: 'var(--primary)', background: 'rgba(98,93,229,.08)', border: '1px solid rgba(98,93,229,.2)', borderRadius: 'var(--radius-full)', padding: '.35rem .85rem', textDecoration: 'none' }}>פתחו את ORIA עכשיו ←</a>
              </div>
            </div>
            <div className="how-step">
          ...
          <ul className="checklist">
            ...
            <li>מעקב תשלומים ובקשות תשלום</li>
          ...
          <div className="cta-inline">
            ...
            <a href="https://app.oriamind.ai/register" className="btn btn-primary">פתחו עכשיו בפלאפון ←</a>
          </div>
